...
public class LakesAdapter extends RecyclerView.Adapter<LakesAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(LakesAdapter.ViewHolder holder, int position) {
